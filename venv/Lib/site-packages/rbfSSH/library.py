...
class rbfSSH(object):
    """rbfSSH is a Robot Framework test library for SSH and SFTP.

     This document explains how to use keywords provided by rbfSSH.
    ...
    rbfSSH supports multiple connections to different hosts.
    ...
    |     ${output}=         `Execute Command`  echo Hello rbfSSH!
    |     `Should Be Equal`    ${output}        Hello rbfSSH!
    |
    ...
    def __init__(self,
        ...
        """rbfSSH allows some import time `configuration`.
        ...
        | Library | rbfSSH | newline=CRLF | path_separator=\\\\ |
        """
    ...
    def open_connection(self, host, alias=None, port=22, timeout=None,
        ...
        | `Open Connection` | 192.168.1.1  | term_type=ansi | width=40 |
         ...
         rbfSSH understands ``Host`` entries from
