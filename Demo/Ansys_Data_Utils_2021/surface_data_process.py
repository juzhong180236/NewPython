...
class SurfaceData(object):
    ...
    def get_Coord_Data(self, whichAxis='xyz'):
        ...
        return self.cd.surfaceCoord_To_List(whichAxis)
    ...
    def get_Displacement_DopSum_Dcolor_Bysorted(self):
        ...
        if not self.cd:
            ...
            return
        dd = DispalcementData(self.path_pre + '/dopAndCoord/', self.ed, self.cd)
        str_displacement, str_dopSum, str_Dcolor, d_step, d_min = dd.surface_Displacement_DopSum_Dcolor_Bysorted()
        return str_displacement, str_dopSum, d_step, d_min
    ...
    def get_Stress_SStepandMin_Bysorted(self):
        ...
        if not self.ed:
            ...
            return
        sd = StressData(self.path_pre + '/equivalent_stress/', self.ed)
        str_stress, str_Scolor, s_step, s_min = sd.surface_Stress_Scolor_Bysorted()
        return str_stress, s_step, s_min
