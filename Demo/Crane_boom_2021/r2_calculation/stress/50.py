...
读入高低保真的18个节点应力数据
"""
list_stress_low = rd.read_stress(path_low_prefix + path_arr["low_50"], mode='v')
...
array_real_stress_high = np.hstack(
    [_array_real_stress_high, np.array(list_real_stress_high).reshape(-1, 1)])
...
def save_to_excel():
    ...
    writer = pd.ExcelWriter(r'D:\Alai\paper_Alai\【1】期刊论文\【1】Journal of Mechanical Design\起重机臂架论文\提交过程\【2】第一次审回\仿真数据\r2\stress\r2_50.xlsx')  # 创建名称为hhh的excel表格
