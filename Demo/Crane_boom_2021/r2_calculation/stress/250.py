...
读入高低保真的18个节点应力数据
"""
list_stress_low = rd.read_stress(path_low_prefix + path_arr["low_250"], mode='v')
...
array_real_stress_high = np.hstack([_array_real_stress_high[:, 0:2],
...
""" 训练集数据：自变量 """
# low_samples
force_arr_low = [5, 8, 11, 14, 17, 20, 23, 26, 29, 32, 35, 38, 41, 44, 47, 50]
degree_arr_low = [0, 4.8, 9.6, 14.4, 19.2, 24, 28.8, 33.6, 38.4, 43.2, 48, 52.8, 57.6, 62.4, 67.2, 72]
# high_samples
train_high = np.asarray([[5, 0], [5, 72], [50, 72]])
# verification_data
'''2020.12.21
...
def save_to_excel():
    ...
    writer = pd.ExcelWriter(
        r'D:\Alai\paper_Alai\【1】期刊论文\【1】Journal of Mechanical Design\起重机臂架论文\提交过程\【2】第一次审回\仿真数据\r2\stress\r2_250.xlsx')  # 创建名称为hhh的excel表格
