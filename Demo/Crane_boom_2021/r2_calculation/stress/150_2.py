...
读入高低保真的18个节点应力数据
"""
list_stress_low = rd.read_stress(path_low_prefix + path_arr["low_150"], mode='v')
...
""" 训练集数据：自变量 """
# low_samples
force_arr_low = [5, 9, 13, 17, 21, 25, 29, 33, 37, 41, 45, 50]
degree_arr_low = [0, 6.5, 13, 19.5, 26, 32.5, 39, 45.5, 52, 58.5, 65, 72]
# high_samples
train_high = np.asarray([[5, 0], [5, 72], [35, 48], [50, 0], [50, 72]])
# verification_data
'''2020.12.21
...
def save_to_excel():
    ...
    writer = pd.ExcelWriter(r'D:\Alai\paper_Alai\【1】期刊论文\【1】Journal of Mechanical Design\起重机臂架论文\提交过程\【2】第一次审回\仿真数据\r2\stress\r2_150_2.xlsx')  # 创建名称为hhh的excel表格
