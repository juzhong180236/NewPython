...
读入高低保真的18个节点应力数据
"""
list_stress_low = rd.read_stress(path_low_prefix + path_arr["low_200"], mode='v')
...
""" 训练集数据：自变量 """
# low_samples
force_arr_low = [5, 8.5, 12, 15.5, 19, 22.5, 26, 29.5, 33, 36.5, 40, 43.5, 47, 50]
degree_arr_low = [0, 5.5, 11, 16.5, 22, 27.5, 33, 38.5, 44, 49.5, 55, 60.5, 66, 72]
# high_samples
train_high = np.asarray([[5, 0], [5, 72], [50, 0], [50, 72]])
# verification_data
'''2020.12.21
...
def save_to_excel():
    ...
    writer = pd.ExcelWriter(
        r'D:\Alai\paper_Alai\【1】期刊论文\【1】Journal of Mechanical Design\起重机臂架论文\提交过程\【2】第一次审回\仿真数据\r2\stress\r2_200.xlsx')  # 创建名称为hhh的excel表格
