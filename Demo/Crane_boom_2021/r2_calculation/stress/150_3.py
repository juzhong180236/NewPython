...
array_real_stress_high = np.hstack([_array_real_stress_high[:, 0:3],
...
# high_samples
train_high = np.asarray([[5, 0], [5, 72], [20, 24], [50, 0], [50, 72]])
# verification_data
'''2020.12.21
...
def save_to_excel():
    ...
    writer = pd.ExcelWriter(r'D:\Alai\paper_Alai\【1】期刊论文\【1】Journal of Mechanical Design\起重机臂架论文\提交过程\【2】第一次审回\仿真数据\r2\stress\r2_150_3.xlsx')  # 创建名称为hhh的excel表格
