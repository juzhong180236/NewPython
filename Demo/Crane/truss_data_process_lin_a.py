...
path_switch = r'pre_truss_30w\\'
# 读取路径(读pre)
path_four_read = path_prefix + path_switch
# 写入路径(写在mid)
path_four_write = path_prefix + r"post_test_30w\\"
# 网格类型
geometry_type = ['3D4']
# 训练自变量
...
dtf.dataToPostFile_v2_Bysorted(v_fd=fd, rbf_type='lin_a', which_part=path_switch[4:-6])
# dtf.dataToMidFile()
