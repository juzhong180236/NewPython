...
path_test = r"C:\Users\asus\Desktop\Papers\paper_result_truss\20200713_stress_data\\"
# 测试数据文件名，实时仿真数据的文件名
...
stress_y_limit_separate = 7  # y刻度分度数
x_tick = 111  # x的最大值
...
# 训练后的数据权重存放的路径
path_train = r"C:\Users\asus\Desktop\Papers\paper_result_truss\20200713_stress_data\stress_point\w\\"
