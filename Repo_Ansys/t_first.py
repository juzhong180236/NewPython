...
ansys.run('*DIM,rst_path_,STRING,128')  # 定义数组rst_path_存储结果文件路径字符串，最大长度为128个字符
...
ansys.run("FILE,rst_path_(1),RST")  # 指定读入ansys中的结果文，FILE
