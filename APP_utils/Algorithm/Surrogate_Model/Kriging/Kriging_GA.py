...
class Kriging(object):
    ...
    def predict(self, X_pre):
        ...
        # 相关矩阵
        matrix = self.corelation(gaussian, x_normalization, x_normalization, parameters)
        # 相关向量
        vector = self.corelation(gaussian, x_normalization, x_pred_normalization, parameters)
        # 权重
